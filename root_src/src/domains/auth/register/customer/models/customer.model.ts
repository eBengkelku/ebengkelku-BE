import { ICustomer, ICustomerWithRoles, IRole } from '../interfaces';

/**
 * Customer Model
 *
 * Domain model for customer entity. Provides factory methods for creating
 * and reconstituting customer instances.
 *
 * @class CustomerModel
 * @version 1.0.0
 * @since 2026-01-27
...
export class CustomerModel {
  ...
  /**
   * Factory method for reconstituting customer from database row
   */
  static reconstitute(data: ICustomer, roles: IRole[] = []): CustomerModel {
    return new CustomerModel(
      data.id,
      data.public_id,
      data.name,
