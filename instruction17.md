<context>
We will create a new endpoint. This endpoint will be GET `/v1/business`. The main purpose of this endpoint is to GET all the data from business. This endpoint will accept Bearer Token in the header. Make sure that the token is valid and the user is authenticated. And also make sure that this endpoint can only be accessed by the owner of the business.
